...
import { SuggestedQueries } from "@/components/chat-with-product/suggested-queries";
import { QueryViewer } from "@/components/chat-with-product/query-viewer";
import { Search } from "@/components/chat-with-product/search";
