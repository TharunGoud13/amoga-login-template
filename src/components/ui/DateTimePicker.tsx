...
export function DateTimePicker({ value, onChange, setInput, form, field }: EnhancedDateTimePickerProps) {
  ...
  const handleDateChange = (newDate: Date | undefined) => {
    if (newDate) {
      ...
      const formattedDate = updatedDate.toLocaleDateString("en-US", { year: "numeric", month: "2-digit", day: "2-digit" });
      ...
      if(form && field){
        form.setValue(field.name, `${formattedDate} ${hours}:${minutes} ${period}`, {
            shouldValidate: true,
            shouldDirty: true,
          }); 
      }
  ...
  const handleHourChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    handleTimeChange({ hours: period === "PM" ? (newHours % 12) + 12 : newHours % 12, minutes })
  }
        ...
        <div className="p-3 border-t flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="flex">
              ...
              <Button
                onClick={() => handleTimeChange({ hours: (hours % 12) + 12, minutes })}
                size="sm"
