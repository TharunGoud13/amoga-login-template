...
export const PLAN_PHASE_API = "https://amogademo-postgrest.morr.biz/plan_phase";
...
export const CHAT_GROUP_API = "https://amogaagents.morr.biz/chat_group";
